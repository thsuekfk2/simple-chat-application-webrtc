...
export const LabelInput = ({ label, ...rest }: Props) => {
  return (
    <div className=" relative bg-gray-900 rounded-full ">
      <input
        type="text"
        className="pl-5 w-full bg-[#fff] peer h-[50px] rounded-full text-gray-200 placeholder-transparent  px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-rose-600"
        placeholder={label}
        {...rest}
      />
      <label
